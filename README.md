...
Бизнес-аналитик с техническим бэкграундом и опытом работы с данными в крупной корпорации (Газпром нефть, 3 года). Специализируюсь на сборе требований, описании процессов (BPMN, UML) и визуализации данных для принятия решений. Прошла профильное обучение в Яндекс Практикуме. В портфолио — 6 проектов по автоматизации отчётности, моделированию процессов и аналитике. Ищу позицию бизнес-аналитика, где смогу применять навыки работы с требованиями и процессами, а не только с данными.
...
- Работа с графами (Gephi) — это дополнительная фишка, оставь в конце
